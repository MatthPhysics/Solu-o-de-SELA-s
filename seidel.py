...
def seidel(tol, erro, k_max):
	...
	while k < k_max and erro > tol: 
    		...
    		k += 1 
	print("iteracoes: ",k)
	print("O erro associado a este metodo e: \n", vec_erro[]) #No indice do vec erro deve ir no numero máximo de iterações
	print("O vetor solucao e dado por: \n ")	
	for i in range(len(x_1)):	
		print(x_1[i])	

seidel(10e-6, 10e5, ) # o último argumento da função deve ser o número de iterações.
